...
class T {
  ...
  async getUserPermission() {
    ...
    if (e.includes("admin"))
      return (
        (this.userPermission = { role: ["admin"], permission: [] }),
        this.userPermission
      );
    const t = await m.where({ role_id: _.in(e) }).get(),
      n =
        ((i = t.data.reduce(
  ...
  async _createToken({ uid: e, role: t, permission: i } = {}) {
    ...
    const o = Date.now(),
      { tokenSecret: s, tokenExpiresIn: c } = this.config,
      a = g({ ...r, uniIdVersion: "1.0.13" }, s, { expiresIn: c }),
...
var E = Object.freeze({
  ...
  checkToken: async function (e, { autoRefresh: t = !0 } = {}) {
    return new T({ uniId: this }).checkToken(e, { autoRefresh: t });
  },
  createToken: async function ({ uid: e, role: t, permission: n } = {}) {
    return new T({ uniId: this }).createToken({
      uid: e,
      role: t,
      permission: n,
    });
  ...
  refreshToken: async function ({ token: e } = {}) {
    return new T({ uniId: this }).refreshToken({ token: e });
  },
});
